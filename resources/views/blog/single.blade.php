        ...
        <div v-for="comment in comments">
            ...
            <div class="author-widget widget-area">
                <div class="selected-author">
                    <div v-html="userGravatar(comment.user.email)" style="height: 30px; width: 30px;"></div>
                    <div class="author">
                        <strong>@{{comment.user.name}} </strong><span>@{{getDate(comment.created_at)}} said:</span>
                        <p>@{{comment.body}}</p>
                    </div>
                </div>
            </div>
