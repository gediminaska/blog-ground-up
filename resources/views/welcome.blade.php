                ...
                <b-tabs v-model="activeTab">
                    <b-tab-item label="Users">
                        ...
                        @foreach($users as $user)
                            <img src="https://www.gravatar.com/avatar/{{md5($user->email)}}?d=mm" alt="" style="height: 20px; width:20px; border-radius: 20px">
